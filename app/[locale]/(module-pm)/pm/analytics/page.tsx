...
import { TrendingDown, Zap, GitBranch, Clock, Users, Building, LayoutDashboard, BarChart3 } from "lucide-react";
import { TeamProductivityDashboard } from "@/components/analytics/TeamProductivityDashboard";
...
export default function AnalyticsPage() {
    ...
    return (
        <div className="h-full overflow-y-auto p-6 space-y-8 max-w-7xl mx-auto no-scrollbar">
            ...
            <Tabs value={activeView} onValueChange={(v: any) => setActiveView(v)} className="w-full">
                <TabsList className="grid w-full max-w-[400px] grid-cols-2 mb-8 h-12 p-1 bg-muted/50">
                    ...
                    <TabsTrigger value="detailed" className="flex items-center gap-2 data-[state=active]:bg-background data-[state=active]:shadow-sm">
                        <BarChart3 size={16} /> Advanced Metrics
                    </TabsTrigger>
                </TabsList>

                <TabsContent value="dashboard" className="animate-in fade-in slide-in-from-bottom-2 duration-300 outline-none">
                    <TeamProductivityDashboard projectId={selectedProjectId} />
                </TabsContent>
